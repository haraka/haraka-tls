...
function makeSocket(props = {}) {
    ...
    s.write = (data, enc, cb) => { if (cb) cb(); return true }
    s.end = () => {}
    s.destroy = () => {}
    s.destroySoon = () => {}
    s.pause = () => {}
...
describe('tls/socket', () => {
    describe('PluggableStream', () => {
        ...
        it('write() delegates to underlying socket', () => {
            ...
            const ps = new PluggableStream(raw)
            let written = null
            raw.write = (d) => { written = d; return true }
